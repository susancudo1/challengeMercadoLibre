...
struct SearchView: View {
    ...
    var body: some View {
        NavigationView {
            ScrollView {
                VStack(alignment: .center) {
                    ...
                    NavigationLink(destination: ListView(searchText: self.viewModel.searchText,
                                                         isNavigationBarHidden: self.$viewModel.isNavigationBarHidden,
                ...
                .alert(isPresented: self.$viewModel.showingAlert,
                       content: {
                    Alert(title: Text("title_alert_search_view".localized),
                          message: Text("message_alert_search_view".localized),
                          dismissButton: .default(Text("button_alert_search_view".localized)))
                })
                .padding()
            }
            ...
            .animation(.spring())
            .onAppear {
                self.viewModel.isNewLoading = true
